...
var G__74306 = o;
goog.object.set(G__74306,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__74336__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__74336 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__74337__i = 0, G__74337__a = new Array(arguments.length -  0);
while (G__74337__i < G__74337__a.length) {G__74337__a[G__74337__i] = arguments[G__74337__i + 0]; ++G__74337__i;}
  args = new cljs.core.IndexedSeq(G__74337__a,0,null);
} 
return G__74336__delegate.call(this,args);};
G__74336.cljs$lang$maxFixedArity = 0;
G__74336.cljs$lang$applyTo = (function (arglist__74338){
var args = cljs.core.seq(arglist__74338);
return G__74336__delegate(args);
});
G__74336.cljs$core$IFn$_invoke$arity$variadic = G__74336__delegate;
return G__74336;
})()
;
} else {
...
var G__74310 = o;
goog.object.set(G__74310,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__74339__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__74339 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__74340__i = 0, G__74340__a = new Array(arguments.length -  0);
while (G__74340__i < G__74340__a.length) {G__74340__a[G__74340__i] = arguments[G__74340__i + 0]; ++G__74340__i;}
  args = new cljs.core.IndexedSeq(G__74340__a,0,null);
} 
return G__74339__delegate.call(this,args);};
G__74339.cljs$lang$maxFixedArity = 0;
G__74339.cljs$lang$applyTo = (function (arglist__74341){
var args = cljs.core.seq(arglist__74341);
return G__74339__delegate(args);
});
G__74339.cljs$core$IFn$_invoke$arity$variadic = G__74339__delegate;
return G__74339;
})()
;
} else {
...
var G__74311 = props;
var G__74311__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__74311,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__74311);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__74311__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__74313 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__74313,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__74313;
}
})(),id_class);
...
var G__74317 = (cljs.core.count(argv) - first_child);
switch (G__74317) {
case (0):
...
var vec__74320 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74320,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74320,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74320,(2),null);
...
var temp__5739__auto___74343 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___74343 == null)){
} else {
var key_74344 = temp__5739__auto___74343;
(jsprops.key = key_74344);
}
...
var temp__5739__auto___74345 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___74345 == null)){
} else {
var key_74346 = temp__5739__auto___74345;
(jsprops.key = key_74346);
}
...
var temp__5739__auto___74347 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___74347 == null)){
} else {
var key_74348 = temp__5739__auto___74347;
(jsprops.key = key_74348);
}
...
var temp__5739__auto___74349 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___74349 == null)){
} else {
var key_74350 = temp__5739__auto___74349;
(jsprops.key = key_74350);
}
...
var temp__5739__auto___74351 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___74351 == null)){
} else {
var key_74352 = temp__5739__auto___74351;
(jsprops.key = key_74352);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__74326_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__74326_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__74327 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74327,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74327,(1),null);
...
break;
default:
var G__74356 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__74357 = compiler;
v = G__74356;
compiler = G__74357;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template74333 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template74333 = (function (opts,id,fn_to_element,meta74334){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template74333.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_74335,meta74334__$1){
var self__ = this;
var _74335__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template74333(self__.opts,self__.id,self__.fn_to_element,meta74334__$1));
}));

(reagent.impl.template.t_reagent$impl$template74333.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_74335){
var self__ = this;
var _74335__$1 = this;
return self__.meta74334;
}));

(reagent.impl.template.t_reagent$impl$template74333.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template74333.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template74333.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template74333.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template74333.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta74334","meta74334",162062201,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template74333.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template74333.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template74333");

(reagent.impl.template.t_reagent$impl$template74333.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template74333");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template74333.
 */
reagent.impl.template.__GT_t_reagent$impl$template74333 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template74333(opts__$1,id__$1,fn_to_element__$1,meta74334){
return (new reagent.impl.template.t_reagent$impl$template74333(opts__$1,id__$1,fn_to_element__$1,meta74334));
});

}

return (new reagent.impl.template.t_reagent$impl$template74333(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
