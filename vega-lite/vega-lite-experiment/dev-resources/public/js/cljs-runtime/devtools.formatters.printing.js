...
var len__4736__auto___42945 = arguments.length;
var i__4737__auto___42946 = (0);
while(true){
if((i__4737__auto___42946 < len__4736__auto___42945)){
args__4742__auto__.push((arguments[i__4737__auto___42946]));

var G__42947 = (i__4737__auto___42946 + (1));
i__4737__auto___42946 = G__42947;
continue;
} else {
}
break;
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42900,G__42901,seq42899__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42912_SHARP_){
return (!((cljs.core.meta(p1__42912_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42926__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42930){var _e__41863__auto__ = e42930;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e42932){var _e__41863__auto__ = e42932;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42935 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42936 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42936);

try{var map__42937 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42937__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42935);
}});
...
var temp__5733__auto___42958 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42958)){
var managed_print_level_42959 = temp__5733__auto___42958;
var _STAR_print_level_STAR__orig_val__42943_42960 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42944_42961 = managed_print_level_42959;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42944_42961);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42939_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42939_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42943_42960);
}} else {
job_fn();
}
