...
var syms = (function (){var iter__4529__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__45998(s__45999){
return (new cljs.core.LazySeq(null,(function (){
var s__45999__$1 = s__45999;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__45999__$1);
if(temp__5735__auto__){
var s__45999__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__45999__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__45999__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__46001 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__46000 = (0);
while(true){
if((i__46000 < size__4528__auto__)){
var i = cljs.core._nth(c__4527__auto__,i__46000);
...
cljs.core.chunk_append(b__46001,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__46031 = (i__46000 + (1));
i__46000 = G__46031;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46001),rewrite_clj$node$fn$fn_walk_$_iter__45998(cljs.core.chunk_rest(s__45999__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46001),null);
}
} else {
var i = cljs.core.first(s__45999__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__45998(cljs.core.rest(s__45999__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__45996_SHARP_){
var or__4126__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__45996_SHARP_);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k46013,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__46017 = k46013;
var G__46017__$1 = (((G__46017 instanceof cljs.core.Keyword))?G__46017.fqn:null);
switch (G__46017__$1) {
case "children":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k46013,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__46018){
var vec__46019 = p__46018;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46019,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46019,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__46012){
var self__ = this;
var G__46012__$1 = this;
return (new cljs.core.RecordIter((0),G__46012__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this46014,other46015){
var self__ = this;
var this46014__$1 = this;
return (((!((other46015 == null)))) && ((this46014__$1.constructor === other46015.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46014__$1.children,other46015.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46014__$1.__extmap,other46015.__extmap)));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__46012){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__46027 = cljs.core.keyword_identical_QMARK_;
var expr__46028 = k__4388__auto__;
if(cljs.core.truth_((pred__46027.cljs$core$IFn$_invoke$arity$2 ? pred__46027.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__46028) : pred__46027.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__46028)))){
return (new rewrite_clj.node.fn.FnNode(G__46012,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__46012),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__46012){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__46012,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__46016){
var extmap__4419__auto__ = (function (){var G__46030 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__46016,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__46016)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46030);
} else {
return G__46030;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__46016),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
