...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k45973,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k45973,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__45978){
var vec__45979 = p__45978;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45979,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45979,(1),null);
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45972){
var self__ = this;
var G__45972__$1 = this;
return (new cljs.core.RecordIter((0),G__45972__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this45974,other45975){
var self__ = this;
var this45974__$1 = this;
return (((!((other45975 == null)))) && ((this45974__$1.constructor === other45975.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45974__$1.whitespace,other45975.whitespace)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45974__$1.__extmap,other45975.__extmap)));
}));
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__45972){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__45983 = cljs.core.keyword_identical_QMARK_;
var expr__45984 = k__4388__auto__;
if(cljs.core.truth_((pred__45983.cljs$core$IFn$_invoke$arity$2 ? pred__45983.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483),expr__45984) : pred__45983.call(null,new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483),expr__45984)))){
return (new rewrite_clj.node.whitespace.WhitespaceNode(G__45972,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.whitespace.WhitespaceNode(self__.whitespace,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__45972),null));
}
}));
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__45972){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.whitespace.WhitespaceNode(self__.whitespace,G__45972,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.whitespace.map__GT_WhitespaceNode = (function rewrite_clj$node$whitespace$map__GT_WhitespaceNode(G__45976){
var extmap__4419__auto__ = (function (){var G__45991 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__45976,new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483));
if(cljs.core.record_QMARK_(G__45976)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__45991);
} else {
return G__45991;
}
})();
return (new rewrite_clj.node.whitespace.WhitespaceNode(new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483).cljs$core$IFn$_invoke$arity$1(G__45976),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k45993,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__46002 = k45993;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k45993,else__4383__auto__);
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45992){
var self__ = this;
var G__45992__$1 = this;
return (new cljs.core.RecordIter((0),G__45992__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"newlines","newlines",-1185451518)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this45994,other45995){
var self__ = this;
var this45994__$1 = this;
return (((!((other45995 == null)))) && ((this45994__$1.constructor === other45995.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45994__$1.newlines,other45995.newlines)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45994__$1.__extmap,other45995.__extmap)));
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__45992){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__46024 = cljs.core.keyword_identical_QMARK_;
var expr__46025 = k__4388__auto__;
if(cljs.core.truth_((pred__46024.cljs$core$IFn$_invoke$arity$2 ? pred__46024.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"newlines","newlines",-1185451518),expr__46025) : pred__46024.call(null,new cljs.core.Keyword(null,"newlines","newlines",-1185451518),expr__46025)))){
return (new rewrite_clj.node.whitespace.NewlineNode(G__45992,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.whitespace.NewlineNode(self__.newlines,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__45992),null));
}
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__45992){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.whitespace.NewlineNode(self__.newlines,G__45992,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.whitespace.map__GT_NewlineNode = (function rewrite_clj$node$whitespace$map__GT_NewlineNode(G__45997){
var extmap__4419__auto__ = (function (){var G__46036 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__45997,new cljs.core.Keyword(null,"newlines","newlines",-1185451518));
if(cljs.core.record_QMARK_(G__45997)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46036);
} else {
return G__46036;
}
})();
return (new rewrite_clj.node.whitespace.NewlineNode(new cljs.core.Keyword(null,"newlines","newlines",-1185451518).cljs$core$IFn$_invoke$arity$1(G__45997),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var comma_46083 = rewrite_clj.node.whitespace.whitespace_node(", ");
/**
...
return cljs.core.butlast(cljs.core.interleave.cljs$core$IFn$_invoke$arity$2(nodes,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(comma_46083)));
});
var nl_46084 = rewrite_clj.node.whitespace.newline_node("\n");
/**
...
return cljs.core.butlast(cljs.core.interleave.cljs$core$IFn$_invoke$arity$2(nodes,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(nl_46084)));
});
var space_46085 = rewrite_clj.node.whitespace.whitespace_node(" ");
/**
 * Interleave the given seq of nodes with `" "` nodes.
 */
rewrite_clj.node.whitespace.space_separated = (function rewrite_clj$node$whitespace$space_separated(nodes){
return cljs.core.butlast(cljs.core.interleave.cljs$core$IFn$_invoke$arity$2(nodes,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(space_46085)));
});
/**
