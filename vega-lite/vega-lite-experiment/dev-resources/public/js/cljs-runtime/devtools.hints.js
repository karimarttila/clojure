...
var map__41995 = top_item;
var map__41995__$1 = (((((!((map__41995 == null))))?(((((map__41995.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41995.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41995):map__41995);
...
}catch (e41992){var _e = e41992;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___42067 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___42067)){
var seen_errors_42068 = temp__5733__auto___42067;
if(cljs.core.truth_(seen_errors_42068.has(self))){
} else {
seen_errors_42068.add(self);

var temp__5735__auto___42070 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___42070)){
var sense_42071 = temp__5735__auto___42070;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_42071)].join(''));
} else {
}
}
} else {
