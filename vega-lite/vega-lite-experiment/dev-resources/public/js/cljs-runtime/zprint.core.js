...
if(typeof x === 'string'){
var vec__62192 = zprint.zprint.determine_ending_split_lines(x);
var line_ending = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62192,(0),null);
var lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62192,(1),null);
...
var vec__62200 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options,null], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?(function (){var vec__62205 = zprint.core.get_zipper(options,coll);
var form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62205,(0),null);
var line_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62205,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [form,options,line_end], null);
})():(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__62208 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62208,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62208,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62200,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62200,(1),null);
var line_ending = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62200,(2),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__62211){
var vec__62212 = p__62211;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62212,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62212,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62215,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62215,(1),null);
...
var vec__62229 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62229,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62229,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62229,(2),null);
var vec__62232 = zprint.config.apply_style.cljs$core$IFn$_invoke$arity$4(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62232,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62232,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62232,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__62237){
var vec__62238 = p__62237;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62238,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62238,(1),null);
...
var vec__62241 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62241,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62241,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62241,(2),null);
...
var vec__62251 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62251,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62251,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62251,(2),null);
var tuple = vec__62251;
...
var G__62505 = cljs.core.next(style_vec);
var G__62506 = ends_w_blanks_QMARK_;
var G__62507 = tuple;
var G__62508 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__62505;
previous_ends_w_blanks_QMARK_ = G__62506;
previous_tuple = G__62507;
out = G__62508;
continue;
}
break;
...
var len__4736__auto___62511 = arguments.length;
var i__4737__auto___62512 = (0);
while(true){
if((i__4737__auto___62512 < len__4736__auto___62511)){
args__4742__auto__.push((arguments[i__4737__auto___62512]));

var G__62514 = (i__4737__auto___62512 + (1));
i__4737__auto___62512 = G__62514;
continue;
} else {
}
break;
...
var vec__62269 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62269,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62269,(1),null);
...
var vec__62272 = zprint.zprint.determine_ending_split_lines(coll);
var line_ending = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62272,(0),null);
var lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62272,(1),null);
...
var result = (function (){var G__62277 = zprint.core.parse_string_all_options(rest_options);
var G__62278 = zprint.core.zprint_str_internal;
var G__62279 = ":parse-string-all? call";
var G__62280 = (function (){var G__62283 = rewrite_clj.parser.parse_string_all(coll__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__62283) : zprint.zutil.edn_STAR_.call(null,G__62283));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__62277,G__62278,G__62279,G__62280) : zprint.core.process_multiple_forms.call(null,G__62277,G__62278,G__62279,G__62280));
})();
...
var vec__62286 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62286,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62286,(1),null);
var line_ending = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62286,(2),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq62262){
var G__62263 = cljs.core.first(seq62262);
var seq62262__$1 = cljs.core.next(seq62262);
var G__62264 = cljs.core.first(seq62262__$1);
var seq62262__$2 = cljs.core.next(seq62262__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62263,G__62264,seq62262__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___62535 = arguments.length;
var i__4737__auto___62536 = (0);
while(true){
if((i__4737__auto___62536 < len__4736__auto___62535)){
args__4742__auto__.push((arguments[i__4737__auto___62536]));

var G__62538 = (i__4737__auto___62536 + (1));
i__4737__auto___62536 = G__62538;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq62325){
var G__62326 = cljs.core.first(seq62325);
var seq62325__$1 = cljs.core.next(seq62325);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62326,seq62325__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___62545 = arguments.length;
var i__4737__auto___62546 = (0);
while(true){
if((i__4737__auto___62546 < len__4736__auto___62545)){
args__4742__auto__.push((arguments[i__4737__auto___62546]));

var G__62547 = (i__4737__auto___62546 + (1));
i__4737__auto___62546 = G__62547;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq62333){
var G__62334 = cljs.core.first(seq62333);
var seq62333__$1 = cljs.core.next(seq62333);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62334,seq62333__$1);
}));
...
var G__62558 = (i__4737__auto___62556 + (1));
i__4737__auto___62556 = G__62558;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq62336){
var G__62337 = cljs.core.first(seq62336);
var seq62336__$1 = cljs.core.next(seq62336);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62337,seq62336__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___62562 = arguments.length;
var i__4737__auto___62563 = (0);
while(true){
if((i__4737__auto___62563 < len__4736__auto___62562)){
args__4742__auto__.push((arguments[i__4737__auto___62563]));

var G__62564 = (i__4737__auto___62563 + (1));
i__4737__auto___62563 = G__62564;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq62345){
var G__62346 = cljs.core.first(seq62345);
var seq62345__$1 = cljs.core.next(seq62345);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62346,seq62345__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__62376,form){
var vec__62377 = p__62376;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62377,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62377,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62377,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62377,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__62385 = (cljs.core.truth_((function (){var and__4115__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4115__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62385,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62385,(1),null);
...
var G__62602 = cljs.core.next(sos);
var G__62603 = comment_QMARK_;
var G__62604 = (function (){var or__4126__auto__ = (!(empty_string_QMARK_));
if(or__4126__auto__){
return or__4126__auto__;
} else {
...
var G__62605 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__62602;
previous_comment_QMARK_ = G__62603;
start_interpolating_QMARK_ = G__62604;
out = G__62605;
continue;
}
break;
...
try{var vec__62425 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62425,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62425,(1),null);
var vec__62428 = zprint.zprint.determine_ending_split_lines(file_str__$1);
var line_ending = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62428,(0),null);
var lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62428,(1),null);
...
var vec__62431 = (cljs.core.truth_((function (){var or__4126__auto__ = range_start__$1;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62431,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62431,(1),null);
...
var vec__62434 = (cljs.core.truth_((function (){var and__4115__auto__ = actual_start;
if(cljs.core.truth_(and__4115__auto__)){
return actual_end;
} else {
return and__4115__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62434,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62434,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62434,(2),null);
...
var forms = (function (){var G__62452 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__62452) : zprint.zutil.edn_STAR_.call(null,G__62452));
})();
