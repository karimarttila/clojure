...
var G__45443 = new_next_nonws_QMARK_;
index = G__45441;
skip_to_right_QMARK_ = G__45442;
next_nonws_QMARK_ = G__45443;
continue;
}
}
break;
...
var G__45450 = zprint.focus.next_ssv(ssv,index);
var G__45451 = (moves - (1));
index = G__45450;
moves = G__45451;
continue;
}
...
var G__45452 = zprint.focus.right_ssv(cljs.core.first(nwp),ssv,zprint.focus.down_ssv(ssv,idx));
var G__45453 = cljs.core.next(nwp);
idx = G__45452;
nwp = G__45453;
continue;
}
