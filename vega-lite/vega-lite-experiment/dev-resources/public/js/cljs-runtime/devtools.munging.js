...
var o42427 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42427["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42428 = temp__5733__auto____$1;
return (o42428["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41852__auto__ = f;
return (o__41852__auto__["toString"]).call(o__41852__auto__);
} else {
return "";
}
}catch (e42432){var _ = e42432;
return "";
}});
...
try{var o__41852__auto___42634 = t;
(o__41852__auto___42634["cljs$lang$ctorPrWriter"]).call(o__41852__auto___42634,t,writer);
}catch (e42435){var __42635 = e42435;
}
...
var char_code = (function (){var o__41852__auto__ = (new String(char$));
return (o__41852__auto__["charCodeAt"]).call(o__41852__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41852__auto__ = String;
return (o__41852__auto__["fromCharCode"]).call(o__41852__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42446 = num_code;
switch (G__42446) {
case (1):
return (185);
...
var o__41852__auto__ = String;
return (o__41852__auto__["fromCharCode"]).call(o__41852__auto__,superscript_code);
});
/**
...
}catch (e42450){var _e__41863__auto__ = e42450;
return false;
}})())){
...
var vec__42451 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42451,(0),null);
...
var len__4736__auto___42659 = arguments.length;
var i__4737__auto___42660 = (0);
while(true){
if((i__4737__auto___42660 < len__4736__auto___42659)){
args__4742__auto__.push((arguments[i__4737__auto___42660]));

var G__42661 = (i__4737__auto___42660 + (1));
i__4737__auto___42660 = G__42661;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42467){
var vec__42468 = p__42467;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42468,(0),null);
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42461){
var G__42462 = cljs.core.first(seq42461);
var seq42461__$1 = cljs.core.next(seq42461);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42462,seq42461__$1);
}));
...
var vec__42473 = cljs.core.split_with((function (p1__42472_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__42472_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42473,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42473,(1),null);
...
var vec__42482 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42482,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42482,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42675 = cljs.core.rest(remaining_tokens);
var G__42676 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42675;
name_tokens = G__42676;
continue;
} else {
...
var vec__42487 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42487,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42487,(1),null);
var vec__42490 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42490,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42490,(1),null);
var vec__42494 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42494,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42494,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42494,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42494,(3),null);
...
var vec__42509 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42509,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42509,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42509,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42509,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42509,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42509,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__42516 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42516,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42516,(1),null);
var vec__42522 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42522,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42522,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__42525 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__42525) : devtools.munging.parse_fn_info_deep.call(null,G__42525));
})()));
}
} else {
return fn_info;
...
var G__42711 = (arity + (1));
var G__42712 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42534){
var vec__42538 = p__42534;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42538,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42538,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42554_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__42554_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42555_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__42555_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___42729 = arguments.length;
var i__4737__auto___42730 = (0);
while(true){
if((i__4737__auto___42730 < len__4736__auto___42729)){
args__4742__auto__.push((arguments[i__4737__auto___42730]));

var G__42731 = (i__4737__auto___42730 + (1));
i__4737__auto___42730 = G__42731;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42558){
var vec__42559 = p__42558;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42559,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42556){
var G__42557 = cljs.core.first(seq42556);
var seq42556__$1 = cljs.core.next(seq42556);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42557,seq42556__$1);
}));
...
var map__42576 = options;
var map__42576__$1 = (((((!((map__42576 == null))))?(((((map__42576.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42576.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42576):map__42576);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42576__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42576__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42576__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42576__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42577 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42577,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42577,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42577,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42577,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42577,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42577,(5),null);
...
var o__41852__auto__ = f;
return (o__41852__auto__["getBasis"]).call(o__41852__auto__);
});
/**
...
}catch (e42590){var _e__41863__auto__ = e42590;
...
var G__42747 = (obj[cljs.core.first(path)]);
var G__42748 = cljs.core.rest(path);
obj = G__42747;
path = G__42748;
continue;
} else {
...
var _STAR_ = (function (accum,p__42603){
var vec__42604 = p__42603;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42604,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42604,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42608){
var vec__42609 = p__42608;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42609,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42609,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42609,(2),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42614_SHARP_){
return (obj[cljs.core.first(p1__42614_SHARP_)]);
}),sorted_matches);
