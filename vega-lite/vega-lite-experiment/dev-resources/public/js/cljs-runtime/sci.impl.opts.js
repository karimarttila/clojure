...
var len__4736__auto___58331 = arguments.length;
var i__4737__auto___58332 = (0);
while(true){
if((i__4737__auto___58332 < len__4736__auto___58331)){
args__4742__auto__.push((arguments[i__4737__auto___58332]));

var G__58333 = (i__4737__auto___58332 + (1));
i__4737__auto___58332 = G__58333;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.opts.process_permissions.cljs$lang$applyTo = (function (seq58312){
...
var G__58337 = null;
var G__58337__1 = (function (msg){
return (new Error(msg));
});
var G__58337__2 = (function (msg,filename){
return (new Error(msg,filename));
});
var G__58337__3 = (function (msg,filename,line){
return (new Error(msg,filename,line));
});
G__58337 = function(msg,filename,line){
switch(arguments.length){
case 1:
return G__58337__1.call(this,msg);
case 2:
return G__58337__2.call(this,msg,filename);
case 3:
return G__58337__3.call(this,msg,filename,line);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__58337.cljs$core$IFn$_invoke$arity$1 = G__58337__1;
G__58337.cljs$core$IFn$_invoke$arity$2 = G__58337__2;
G__58337.cljs$core$IFn$_invoke$arity$3 = G__58337__3;
return G__58337;
})()
], null),new cljs.core.Symbol(null,"cljs.core.Delay","cljs.core.Delay",-1917476777,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.Delay,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__58313_SHARP_){
return (new cljs.core.Delay(p1__58313_SHARP_,null));
})], null),new cljs.core.Symbol(null,"goog.string.StringBuffer","goog.string.StringBuffer",-1220229842,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),goog.string.StringBuffer,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__58314_SHARP_){
return (new goog.string.StringBuffer(p1__58314_SHARP_));
})], null)], null);
...
var vec__58315 = temp__5733__auto__;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58315,(0),null);
var class_opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58315,(1),null);
var G__58342 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(class__GT_opts,sym,((cljs.core.map_QMARK_(class_opts))?class_opts:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),class_opts], null)));
var G__58343 = cljs.core.rest(kvs);
class__GT_opts = G__58342;
kvs = G__58343;
continue;
} else {
...
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58319__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58319__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58319__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58319__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58319__$1,new cljs.core.Keyword(null,"reify","reify",245008172));
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58319__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var disable_arity_checks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58319__$1,new cljs.core.Keyword(null,"disable-arity-checks","disable-arity-checks",1131364206));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58319__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58319__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58319__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var uberscript = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58319__$1,new cljs.core.Keyword(null,"uberscript","uberscript",701571092));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58319__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58319__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58319__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
