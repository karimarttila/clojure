...
if((c === "\n")){
var G__46174 = escape_QMARK_;
var G__46175 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__46174;
lines = G__46175;
continue;
} else {
buf.append(c);

var G__46176 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__46177 = lines;
escape_QMARK_ = G__46176;
lines = G__46177;
continue;
...
var G__46171 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__46171) : rewrite_clj.node.string_node.call(null,G__46171));
});
...
var G__46172 = cljs.core.re_pattern(regex);
var G__46173 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__46172,G__46173) : rewrite_clj.node.token_node.call(null,G__46172,G__46173));
});
