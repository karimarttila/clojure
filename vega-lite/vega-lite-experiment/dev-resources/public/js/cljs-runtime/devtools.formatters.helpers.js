...
var G__42736 = devtools.prefs.pref(v);
v = G__42736;
continue;
} else {
return v;
...
}catch (e42683){var _e__41863__auto__ = e42683;
return false;
}})();
...
}catch (e42691){var _e__41863__auto__ = e42691;
return false;
}})();
...
}catch (e42693){var _e__41863__auto__ = e42693;
return false;
}}
}
});
...
var vec__42708 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42708,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42708,(1),null);
...
return cljs.core.some((function (p1__42713_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42713_SHARP_);
}),template);
});
