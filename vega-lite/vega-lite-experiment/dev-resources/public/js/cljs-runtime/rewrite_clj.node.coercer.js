...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__46145 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__46145) : f.call(null,G__46145));
})(),sq);
});
...
var comma_46178 = rewrite_clj.node.whitespace.whitespace_node(", ");
var space_46179 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.butlast(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__46146){
var vec__46147 = p__46146;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46147,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46147,(1),null);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [rewrite_clj.node.protocols.coerce(k),space_46179,rewrite_clj.node.protocols.coerce(v),comma_46178], null);
