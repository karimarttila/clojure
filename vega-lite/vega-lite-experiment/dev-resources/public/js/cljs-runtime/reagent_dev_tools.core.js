...
reagent_dev_tools.core.dev_state = (function (){var G__76078 = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"height","height",1025178622),(300)], null),(function (){try{return cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(localStorage.getItem(reagent_dev_tools.core.storage_key));
}catch (e76079){var _ = e76079;
return null;
}})()], 0)));
cljs.core.add_watch(G__76078,new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068),(function (_,___$1,old,v){
...
reagent_dev_tools.core.dev_tool = (function reagent_dev_tools$core$dev_tool(p__76088){
var map__76089 = p__76088;
var map__76089__$1 = (((((!((map__76089 == null))))?(((((map__76089.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76089.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__76089):map__76089);
var panels = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__76089__$1,new cljs.core.Keyword(null,"panels","panels",801034044),reagent_dev_tools.core.default_panels);
...
})], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.reagent-dev-tools__nav","div.reagent-dev-tools__nav",-2046412039),(function (){var iter__4529__auto__ = (function reagent_dev_tools$core$dev_tool_$_iter__76097(s__76098){
return (new cljs.core.LazySeq(null,(function (){
var s__76098__$1 = s__76098;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__76098__$1);
if(temp__5735__auto__){
var s__76098__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__76098__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__76098__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__76100 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__76099 = (0);
while(true){
if((i__76099 < size__4528__auto__)){
var vec__76107 = cljs.core._nth(c__4527__auto__,i__76099);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76107,(0),null);
var map__76110 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76107,(1),null);
var map__76110__$1 = (((((!((map__76110 == null))))?(((((map__76110.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76110.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__76110):map__76110);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76110__$1,new cljs.core.Keyword(null,"label","label",1718410804));
cljs.core.chunk_append(b__76100,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.reagent-dev-tools__nav-li","div.reagent-dev-tools__nav-li",-2142897539),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.name(k)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.reagent-dev-tools__nav-li-a","a.reagent-dev-tools__nav-li-a",-1891887548),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core.keyword_identical_QMARK_(current_k,k))?"reagent-dev-tools__nav-li-a--active":null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__76099,vec__76107,k,map__76110,map__76110__$1,label,c__4527__auto__,size__4528__auto__,b__76100,s__76098__$2,temp__5735__auto__,current_k,current_panel,current_content,map__76089,map__76089__$1,panels){
return (function (){
...
});})(i__76099,vec__76107,k,map__76110,map__76110__$1,label,c__4527__auto__,size__4528__auto__,b__76100,s__76098__$2,temp__5735__auto__,current_k,current_panel,current_content,map__76089,map__76089__$1,panels))
], null),label], null)], null));

var G__76163 = (i__76099 + (1));
i__76099 = G__76163;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__76100),reagent_dev_tools$core$dev_tool_$_iter__76097(cljs.core.chunk_rest(s__76098__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__76100),null);
}
} else {
var vec__76125 = cljs.core.first(s__76098__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76125,(0),null);
var map__76128 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76125,(1),null);
var map__76128__$1 = (((((!((map__76128 == null))))?(((((map__76128.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76128.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__76128):map__76128);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76128__$1,new cljs.core.Keyword(null,"label","label",1718410804));
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.reagent-dev-tools__nav-li","div.reagent-dev-tools__nav-li",-2142897539),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.name(k)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.reagent-dev-tools__nav-li-a","a.reagent-dev-tools__nav-li-a",-1891887548),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core.keyword_identical_QMARK_(current_k,k))?"reagent-dev-tools__nav-li-a--active":null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__76125,k,map__76128,map__76128__$1,label,s__76098__$2,temp__5735__auto__,current_k,current_panel,current_content,map__76089,map__76089__$1,panels){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(reagent_dev_tools.core.dev_state,cljs.core.assoc,new cljs.core.Keyword(null,"current","current",-1088038603),k);
});})(vec__76125,k,map__76128,map__76128__$1,label,s__76098__$2,temp__5735__auto__,current_k,current_panel,current_content,map__76089,map__76089__$1,panels))
], null),label], null)], null),reagent_dev_tools$core$dev_tool_$_iter__76097(cljs.core.rest(s__76098__$2)));
}
} else {
return null;
}
