...
var G__48169 = x;
var G__48169__$1 = (((G__48169 == null))?null:cljs.core.meta(G__48169));
if((G__48169__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("sci.impl","op","sci.impl/op",950953978).cljs$core$IFn$_invoke$arity$1(G__48169__$1);
}
});
...
var map__48194 = cljs.core.meta(iobj);
...
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48194__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48194__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48194__$1,new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.vars.current_file));
...
var fm = (function (){var or__4126__auto__ = new cljs.core.Keyword("sci.impl","f-meta","sci.impl/f-meta",-1735495322).cljs$core$IFn$_invoke$arity$1(node);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
var G__48224 = f;
...
return cljs.core.meta(G__48224);
}
}
})();
...
var ex_msg_48291 = e.message;
var map__48225_48292 = cljs.core.meta(node);
var map__48225_48293__$1 = (((((!((map__48225_48292 == null))))?(((((map__48225_48292.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48225_48292.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__48225_48292):map__48225_48292);
var line_48294 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48225_48293__$1,new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(ctx));
var column_48295 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48225_48293__$1,new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"column","column",2078222095).cljs$core$IFn$_invoke$arity$1(ctx));
var file_48296 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48225_48293__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var ex_msg_48297__$1 = (cljs.core.truth_((function (){var and__4115__auto__ = ex_msg_48291;
if(cljs.core.truth_(and__4115__auto__)){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(fm);
} else {
return and__4115__auto__;
}
})())?clojure.string.replace(ex_msg_48291,/(sci\.impl\.)?fns\/fun\/[a-zA-Z0-9-]+--\d+/,cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(fm))):ex_msg_48291);
if(cljs.core.truth_((function (){var and__4115__auto__ = line_48294;
if(cljs.core.truth_(and__4115__auto__)){
return column_48295;
} else {
return and__4115__auto__;
...
var m_48306__$1 = ex_msg_48297__$1;
var new_exception_48307 = (function (){var d__$1 = cljs.core.ex_data(e);
var base = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("sci","error","sci/error",-979082803),new cljs.core.Keyword(null,"line","line",212345235),line_48294,new cljs.core.Keyword(null,"column","column",2078222095),column_48295,new cljs.core.Keyword(null,"message","message",-406056002),m_48306__$1,new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557),(new cljs.core.Delay((function (){
var temp__5735__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(new cljs.core.Keyword(null,"env","env",-1815813235).cljs$core$IFn$_invoke$arity$1(ctx)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(ctx)], null));
if(cljs.core.truth_(temp__5735__auto__)){
...
}),null)),new cljs.core.Keyword(null,"file","file",-1269645878),file_48296,new cljs.core.Keyword(null,"locals","locals",535295783),new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ctx)], null);
...
return cljs.core.ex_info.cljs$core$IFn$_invoke$arity$3(m_48306__$1,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([base__$1,d__$1], 0)),e);
})();
throw new_exception_48307;
} else {
throw e;
}
}
...
var i__4737__auto___48317 = (0);
while(true){
if((i__4737__auto___48317 < len__4736__auto___48315)){
args__4742__auto__.push((arguments[i__4737__auto___48317]));

var G__48318 = (i__4737__auto___48317 + (1));
i__4737__auto___48317 = G__48318;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq48233){
var G__48234 = cljs.core.first(seq48233);
var seq48233__$1 = cljs.core.next(seq48233);
var G__48235 = cljs.core.first(seq48233__$1);
var seq48233__$2 = cljs.core.next(seq48233__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48234,G__48235,seq48233__$2);
}));
...
var G__48246 = cljs.core.namespace(sym);
switch (G__48246) {
case "clojure.core":
case "cljs.core":
...
return (new cljs.core.MapEntry((function (){var G__48255 = cljs.core.key(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__48255) : inner.call(null,G__48255));
...
var run = cljs.core.cons(fst,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__48275_SHARP_){
return f(p1__48275_SHARP_);
}),cljs.core.next(s)));
return cljs.core.cons(run,(function (){var G__48276 = pred;
var G__48277 = (new cljs.core.LazySeq(null,(function (){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(run),s);
}),null,null));
return (sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2 ? sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2(G__48276,G__48277) : sci.impl.utils.split_when.call(null,G__48276,G__48277));
})());
} else {
return null;
}
