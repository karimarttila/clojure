...
if((typeof devtools !== 'undefined') && (typeof devtools.toolbox !== 'undefined') && (typeof devtools.toolbox.t_devtools$toolbox45132 !== 'undefined')){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox45132 = (function (obj,header,style,tag,meta45133){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
(devtools.toolbox.t_devtools$toolbox45132.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_45134,meta45133__$1){
var self__ = this;
var _45134__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox45132(self__.obj,self__.header,self__.style,self__.tag,meta45133__$1));
}));

(devtools.toolbox.t_devtools$toolbox45132.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_45134){
var self__ = this;
var _45134__$1 = this;
return self__.meta45133;
}));

(devtools.toolbox.t_devtools$toolbox45132.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL);

(devtools.toolbox.t_devtools$toolbox45132.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox45132.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
}));

(devtools.toolbox.t_devtools$toolbox45132.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox45132.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta45133","meta45133",-1253720482,null)], null);
}));

(devtools.toolbox.t_devtools$toolbox45132.cljs$lang$type = true);

(devtools.toolbox.t_devtools$toolbox45132.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox45132");

(devtools.toolbox.t_devtools$toolbox45132.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"devtools.toolbox/t_devtools$toolbox45132");
}));

/**
 * Positional factory function for devtools.toolbox/t_devtools$toolbox45132.
 */
devtools.toolbox.__GT_t_devtools$toolbox45132 = (function devtools$toolbox$__GT_t_devtools$toolbox45132(obj__$1,header__$1,style__$1,tag__$1,meta45133){
return (new devtools.toolbox.t_devtools$toolbox45132(obj__$1,header__$1,style__$1,tag__$1,meta45133));
});

}

return (new devtools.toolbox.t_devtools$toolbox45132(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
}));
