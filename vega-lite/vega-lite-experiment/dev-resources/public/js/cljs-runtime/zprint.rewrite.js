...
var G__46848 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__46848;
continue;
} else {
var G__46849 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__46849;
continue;
}
} else {
var G__46854 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__46854;
continue;
}
}
...
var G__46796 = zloc;
var G__46797 = (function (){var G__46798 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__46799 = zloc;
var G__46799__$1 = (((G__46799 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__46799) : rewrite_clj.zip.node.call(null,G__46799)));
if((G__46799__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__46799__$1) : zprint.zutil.edn_STAR_.call(null,G__46799__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__46798) : rewrite_clj.zip.root.call(null,G__46798));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__46796,G__46797) : rewrite_clj.zip.replace.call(null,G__46796,G__46797));
});
/**
...
var G__46893 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__46893;
continue;
}
break;
...
var G__46895 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__46896 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__46895;
out = G__46896;
continue;
} else {
...
var G__46898 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__46899 = cljs.core.next(new_loc);
var G__46900 = replaced_loc;
nloc = G__46898;
new_loc = G__46899;
last_loc = G__46900;
continue;
...
return zprint.rewrite.sort_val((function (){var G__46827 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__46827) : rewrite_clj.zip.down.call(null,G__46827));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__46830_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__46830_SHARP_) : rewrite_clj.zip.tag.call(null,p1__46830_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__46830_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__46830_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
