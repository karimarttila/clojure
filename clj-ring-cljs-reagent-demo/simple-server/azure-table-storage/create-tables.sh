...
if [ $# -ne 3 ]
then
  echo "Usage: ./create-tables.sh <azure-profile> <env> <prefix>"
  echo "Example: ./create-tables.sh azure dev karissvmdemo1"
  exit 1
fi
...
echo "Creating table $MY_SESSION_TABLE... and other tables"
